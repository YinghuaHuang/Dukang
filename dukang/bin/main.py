...
from opennmt.bin.main import _set_log_level
from opennmt.config import load_config
from opennmt.utils.misc import classes_in_module

from dukang import __version__
from dukang.config import load_model
from dukang.models import catalog
from dukang.runner import DistillRunner

def main():
  parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
  parser.add_argument("-v", "--version", action="version", version="dukang %s" % __version__)
